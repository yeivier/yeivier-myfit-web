...
/** Nombre visible del grupo muscular, contemplando los personalizados. */
export function muscleGroupName(targetMuscleGroup: MuscleGroup, customMuscleGroup?: string | null) {
	if (targetMuscleGroup === 'Custom') return customMuscleGroup || 'Personalizado';
	return muscleGroupLabels[targetMuscleGroup];
}
