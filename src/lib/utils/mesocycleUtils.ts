...
import type { FullMesocycle, WorkoutsOfMesocycle, WorkoutWithExercises, WorkoutExerciseWithSets } from '@/lib/server/includes';
...
export function groupExercisesByMuscleGroup(exercises: WorkoutExerciseWithSets[]): GroupedExercisesByMuscleGroup {
...
type GroupedExercisesByName = {
	name: string;
	performances: WorkoutExerciseWithSets[];
}[];

export function groupExercisesByName(exercises: WorkoutExerciseWithSets[]): GroupedExercisesByName {
...
export function groupWorkoutsBySplitDayName(
	workoutsOfMesocycle: WorkoutsOfMesocycle,
	splitDays: FullMesocycle['mesocycleExerciseSplitDays']
...
export function generatePerformanceChangesPerSplitDay(mesocycle: FullMesocycle) {
